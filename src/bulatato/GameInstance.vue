...
const resetEnemy = () => {
  const delta_X = Math.random() * enemy.value.resetDistance-enemy.value.resetDistance/2;
  const delta_Y = Math.random() *enemy.value.resetDistance-enemy.value.resetDistance/2;
